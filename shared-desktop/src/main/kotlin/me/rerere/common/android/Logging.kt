...
object Logging {
    ...
    fun getRecentLogs(): List<LogEntry> = recentLogs.toList()

    fun getTextLogs(): List<LogEntry.TextLog> = recentLogs.filterIsInstance<LogEntry.TextLog>()

    fun getRequestLogs(): List<LogEntry.RequestLog> = recentLogs.filterIsInstance<LogEntry.RequestLog>()
